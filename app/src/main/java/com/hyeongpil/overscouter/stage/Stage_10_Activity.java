...
public class Stage_10_Activity extends BaseActivity {
    final static String TAG = Stage_10_Activity.class.getSimpleName();

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        container.setLayoutResource(R.layout.activity_stage10);

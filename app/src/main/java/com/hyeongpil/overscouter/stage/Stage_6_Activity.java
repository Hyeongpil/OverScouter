...
public class Stage_6_Activity extends BaseActivity {
    final static String TAG = Stage_6_Activity.class.getSimpleName();

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        container.setLayoutResource(R.layout.activity_stage6);
